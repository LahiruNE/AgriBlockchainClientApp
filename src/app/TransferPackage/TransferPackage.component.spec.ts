...
import { TransferPackageComponent } from './TransferPackage.component';
...
describe('TransferPackageComponent', () => {
  ...
  let mockTransferPackageService;
  let mockDataService

  beforeEach(async(() => {

    mockTransferPackageService = sinon.createStubInstance(TransferPackageService);
    mockTransferPackageService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: TransferPackageService, useValue: mockTransferPackageService },
