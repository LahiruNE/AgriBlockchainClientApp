...
@Component({
  ...
  providers: [TransferPackageService]
})
export class TransferPackageComponent implements OnInit {
  ...
  constructor(private serviceTransferPackage: TransferPackageService, fb: FormBuilder) {
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceTransferPackage.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
